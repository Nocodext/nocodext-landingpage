          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4 animate-fade-in opacity-0" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
              <button 
                ...
                className="flex items-center h-14 rounded-full bg-gradient-to-r from-pink-50 to-blue-50 text-gray-600 font-medium shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 overflow-hidden"
              >
                <div className="flex h-full items-center justify-center bg-neutral-100 aspect-square rounded-l-full">
